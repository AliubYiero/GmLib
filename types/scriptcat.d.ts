// @reference https://raw.githubusercontent.com/scriptscat/scriptcat/refs/heads/main/src/types/scriptcat.d.ts
...
declare function GM_download(
    details: GMTypes.DownloadDetails<string | Blob | File>,
...
declare function GM_getTabs(
    callback: (objs: { [key: number]: object }) => void,
): void;
...
declare namespace GMTypes {
    ...
    type SWOpenTabOptions = OpenTabOptions &
        Required<Pick<OpenTabOptions, 'active'>>;
    ...
    type NotificationOnClick = (
        ...
        event: NotificationOnClickEvent,
    ) => unknown;
